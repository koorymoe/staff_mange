...
func versionedMigrations() []Migration {
	...
	// 0251–0253: مختبر المحاكاة — «أريد محاكيات… يجي يطبّق هنا».
	...
	// ⚠️ رقمها يقفز من 0286 مباشرة لـ0289 على `prod` تحديداً: 0287-0288
	// (دفتر ذمة الموظف) موجودة بس على `avg` (ميزة موقوفة بطلب صاحب
