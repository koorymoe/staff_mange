...
// حرفياً مثل الاكسل: العدد × سعر الشريحة.
//
//	G59 = IFS(E58="",           G58,
//	          E58 بين 1 و 4,    MAX(G58, E58*14000),
//	          E58 بين 5 و 8,    MAX(G58, E58*12500),
//	          E58 بين 9 و 16,   MAX(G58, E58*11500),
//	          E58 >= 17,        MAX(G58, E58*10000),
//	          TRUE,             G58)
//
// ملاحظة تسعيرة الجملة: عند حدود الشرائح ينزل الحد الأدنى (17×10000=170,000
// أقل من 16×11500=184,000). هذا سلوك الاكسل نفسه ونلتزم بيه حتى يطلع نفس
// الرقم بالضبط. عملياً ما يأثر لأنه MAX مع المجموع المحسوب يغطيه — الحد
// الأدنى ينطبق بس لما الحساب التفصيلي أوطى منه.
func installMinimumTotal(deviceCount int) float64 {
	if deviceCount <= 0 {
		return 0
	}
	return installMinimumPerDevice(deviceCount) * float64(deviceCount)
}
