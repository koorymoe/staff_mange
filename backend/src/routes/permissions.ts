...
router.put('/employee/:employeeId', requireAuth, requireRole('ADMIN'), async (req, res) => {
...
router.post('/employee/:employeeId/apply-defaults', requireAuth, requireRole('ADMIN'), async (req, res) => {
  const { employeeId } = req.params
