...
export interface PartDef {
  ...
  geo3d?: {
    ...
    tiltDeg?: number
    /** ═══ ارتفاع الجهاز بوحدات الرف (1U = ٤٤٫٤٥ مم) ═══
     *
     *  ⚠️ **غيابه يعني الجهاز ما ينركّب برف** — وهذا تصريح مو تخمين.
     *  استنتاجه من العرض («≥٣٠ سم يعني رفّ») يحشر لوحة الحريق
     *  والبطارية والشاشة بالرف، والأسوأ إن الغلط **ما يبيّن كخطأ**:
     *  المشهد يطلع شغّالاً ويعلّم شي ما يصير بالميدان. */
    rackU?: number
    features?: unknown[]
  }
...
export type DomainId = 'electrical' | 'solar' | 'network' | 'fire' | 'audio' | 'gpon' | 'cctv' | 'access'
