...
export const navItems: NavItem[] = [
  ...
  { to: '/leader-invoices/new?service=1', label: '🛰️ فاتورة خدمة (جي بي اس / داش كام)', icon: icon('M12 2v4M12 18v4M2 12h4M18 12h4M7.8 7.8 4.9 4.9M16.2 7.8l2.9-2.9M7.8 16.2l-2.9 2.9M16.2 16.2l2.9 2.9'), anyPermission: ['invoice_gps', 'invoice_dashcam'] },
