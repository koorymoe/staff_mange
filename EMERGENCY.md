...
> الإشعار يروح لحسابك أنت (المالك) بس — ولا حساب ثاني بالنظام يشوفه.

## 🔐 شاشة «النسخ الاحتياطية» — لك وحدك

من القائمة الجانبية بحسابك (المالك): **🔐 النسخ الاحتياطية**.
تعرضلك حالة النسخ وسجل كل تشغيل — نجح لو فشل، الحجم، عدد الجداول،
طلعت برّا السيرفر لو لا، ومشفّرة لو لا.

هذي الشاشة **ما تظهر لأي حساب ثاني، ولا حتى لمدير النظام (ADMIN)**، ومسارها
بالسيرفر يرجّع «غير موجود» لأي حساب غير حسابك. يعني تكدر تسلّم إدارة
النظام لغيرك وتبقى مراقبة النسخ عندك أنت بس.
